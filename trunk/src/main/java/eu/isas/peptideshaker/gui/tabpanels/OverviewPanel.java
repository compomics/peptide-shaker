...
public class OverviewPanel extends javax.swing.JPanel implements ProteinSequencePanelParent {
    ...
    private void setProteinTableProperties() {
        ...
        ((JSparklinesArrayListBarChartTableCellRenderer) proteinTable.getColumn("#Spectra").getCellRenderer()).showNumberAndChart(true, peptideShakerGUI.getLabelWidth(), new DecimalFormat("0"));
    ...
    private void setPeptideTableProperties() {
        ...
        ((JSparklinesArrayListBarChartTableCellRenderer) peptideTable.getColumn("#Spectra").getCellRenderer()).showNumberAndChart(true, peptideShakerGUI.getLabelWidth(), new DecimalFormat("0"));
                ...
                for (String spectrumKey : selectedPsmKeys) {
                    ...
                    if (currentSpectrum != null) {
                        ...
                        annotationPreferences.setCurrentSettings(
                                ...
                                !currentSpectrumKey.equalsIgnoreCase(spectrumKey), PeptideShaker.MATCHING_TYPE, peptideShakerGUI.getSearchParameters().getFragmentIonAccuracy());
