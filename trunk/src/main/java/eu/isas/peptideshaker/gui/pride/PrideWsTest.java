...
public class PrideWsTest {
    ...
    public static void main(String[] args) {
        ...
        // http://www.ebi.ac.uk:80/pride/ws/archive/project/list?show=1000&page=1&sort=publication_date&order=desc
        //
        // to get the details for a given project
        // http://www.ebi.ac.uk:80/pride/ws/archive/project/PXD000375
        //
        // to get all assays for a given project
        // http://www.ebi.ac.uk:80/pride/ws/archive/assay/list/project/PXD000375
        //
        // to get the details of a given assay
        // http://www.ebi.ac.uk:80/pride/ws/archive/assay/30323
        //
        // to get all the files for a given project
        // http://www.ebi.ac.uk:80/pride/ws/archive/file/list/project/PXD000375
        //
        // to get all the files for a given assay
        // http://www.ebi.ac.uk:80/pride/ws/archive/file/list/assay/30323
        //
        ...
        projectAccession = "PXD000651";
        template = new RestTemplate();
        ResponseEntity<ProjectDetail> entity;
        entity = template.exchange("http://www.ebi.ac.uk/pride/ws/archive/project/" + projectAccession, HttpMethod.GET, requestEntity, ProjectDetail.class);
