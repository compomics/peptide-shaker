...
public enum FollowUpCLIParams {
    ...
    MS2PIP_FOLDER("ms2pip_folder", "Folder where to save the ms2pip training files.", false);
    ...
    public static void createOptionsCLI(Options aOptions) {
        ...
        aOptions.addOption(MS2PIP_FOLDER.id, true, MS2PIP_FOLDER.description);
    ...
    public static String getOutputOptionsAsString() {
        ...
        output += "\nms2pip training\n\n";
        output += "-" + String.format(formatter, MS2PIP_FOLDER.id) + " " + MS2PIP_FOLDER.description + "\n";
