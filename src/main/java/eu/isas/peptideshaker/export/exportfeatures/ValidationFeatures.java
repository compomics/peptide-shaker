...
public enum ValidationFeatures implements ExportFeature {
    ...
    validated_protein("Protein # Validated", "The number of validated proteins."),
    ...
    validated_peptide("Peptide # Validated", "The number of validated peptides. Note that peptides are grouped by modification status when statistical significance is ensured, i.e. \"Confidence accuracy\" < 1%."),
