    ...
    private void writeSpectrumIdentificationResult(long spectrumMatchKey, int spectrumMatchIndex)
        ...
        if (bestPeptideAssumption != null) {
            ...
            if (writeFragmentIons) {
                ...
                SpecificAnnotationParameters specificAnnotationPreferences = annotationPreferences.getSpecificAnnotationPreferences(spectrumKey, bestPeptideAssumption, sequenceProvider, identificationParameters.getSequenceMatchingParameters(), identificationParameters.getModificationLocalizationParameters().getSequenceMatchingPreferences());
