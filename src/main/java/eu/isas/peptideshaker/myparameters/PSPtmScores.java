...
public class PSPtmScores implements UrParameter {
    ...
    /**
     * Adds a main modification site and removes the corresponding secondary
     * modification site if found.
     *
    ...
    /**
     * Returns the secondary potential modifications at the given amino acid
     * index.
     *
     * @param aa the index in the sequence (0 is first amino acid)
     * @return a list containing all potential modifications as main match, an
