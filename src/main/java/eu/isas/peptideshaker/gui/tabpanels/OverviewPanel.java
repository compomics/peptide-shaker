        ...
        if (tableIndex == TableIndex.PROTEIN_TABLE
            ...
            if (tableIndex == TableIndex.PROTEIN_TABLE) {
                ...
                outputGenerator.getPeptidesOutput(
                        null, selectedPeptides, null, true, false, true, true, true, true,
                ...
                if (includePeptide) {
                    for (int peptideStart : currentProtein.getPeptideStart(peptideSequence)) {
                        ...
                        if (((startIndex <= peptideStart && peptideStart <= endIndex)
                            ...
                            String modifiedSequence = peptideShakerGUI.getDisplayFeaturesGenerator().getColoredPeptideSequence(peptideKey, false);
