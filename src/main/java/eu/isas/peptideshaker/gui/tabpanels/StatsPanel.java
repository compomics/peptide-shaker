...
public class StatsPanel extends javax.swing.JPanel {
     ...
     */
    private ProgressDialogX progressDialogX;
    /**
    ...
    private void initComponents() {
        ...
        fdrFnrPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, fdrFnrPanelLayout.createSequentialGroup()
                ...
                .addGroup(fdrFnrPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(fdrPlotLayeredPane, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
        ...
        parametersJPanelLayout.setVerticalGroup(
            ...
            .addGroup(parametersJPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(parametersJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(estimatorHelpJButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(parametersJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void windowTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_windowTxtActionPerformed
        try {
            ...
            if (newWindow < 0) {
                ...
                progressDialogX = new ProgressDialogX(peptideShakerGUI, true);
                progressDialogX.setTitle("Recalculating. Please Wait...");
                progressDialogX.setIndeterminate(true);
                progressDialogX.setUnstoppable(true);
                ...
                new Thread("RecalculateThread") {
                    ...
                    public void run() {
                        ...
                        currentTargetDecoyMap.estimateProbabilities(progressDialogX);
    ...
    private void recalculatePeptidesAndProteins() {
        ...
        new Thread("RecalculateThread") {
            ...
            public void run() {
                ...
                try {
                    miniShaker.spectrumMapChanged(progressDialogX);
                } catch (Exception e) {
    ...
    private void recalculateProteins() {
        ...
        new Thread("RecalculateThread") {
            ...
            public void run() {
                ...
                try {
                    miniShaker.peptideMapChanged(progressDialogX);
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(peptideShakerGUI, "An identification conflict occured. If you can reproduce the error please contact the developers.",
                            "Identification Conflict", JOptionPane.WARNING_MESSAGE);
                    e.printStackTrace();
...
try {
                ...
                miniShaker.proteinMapChanged(progressDialogX);
                modifiedMaps.put(0, false);
} catch (Exception e) {
    peptideShakerGUI.catchException(e);
}
